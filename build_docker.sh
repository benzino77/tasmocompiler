...
docker build --build-arg BASE_IMAGE=arm32v7/node:10.15.3-stretch-slim -t benzino77/tasmocompiler:arm32v7 -t benzino77/tasmocompiler:"${VERSION}"-arm32v7 .
docker build --build-arg BASE_IMAGE=arm64v8/node:10.15.3-stretch-slim -t benzino77/tasmocompiler:arm64v8 -t benzino77/tasmocompiler:"${VERSION}"-arm64v8 .
